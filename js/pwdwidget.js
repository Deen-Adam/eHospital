...
function _MakePWDWidget()
{
	...
	code += "<input type='password' class='pwdfield' name='"+pwdname+"' id='"+this.pwdfieldid+"' required <label>New Password</label> ";
	...
	code += "<div class='pwdstrength' id='"+this.pwdstrengthdiv+"' style='float: right;'>";
